...
public sealed class CompletionUiTests
{
    ...
    [AvaloniaFact] public void App_initializes_tray_only_for_non_headless_lifetime() { var app = Assert.IsType<App>(Avalonia.Application.Current); Assert.NotNull(app.TrayFactory); }
}
