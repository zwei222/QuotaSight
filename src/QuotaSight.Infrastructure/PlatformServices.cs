...
public sealed record AppSettingsDto(string Theme = "System", string Language = "English", int RefreshMinutes = 10, decimal OverallThreshold = 80, bool NotificationsEnabled = true, string GithubOAuthClientId = "", Dictionary<string, decimal>? ProviderThresholds = null, bool ResidentMode = false, string GithubOrganization = "");
